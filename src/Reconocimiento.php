...
if (!empty($_POST)) {
    ...
    $id = $_POST['id'];
    $codigo = $_POST['codigo'];
    $reconum = $_POST['reconum'];
    $precio = $_POST['precio'];
    $fecha = $_POST['fecha'];
    if (empty($codigo) || empty($reconum) || empty($precio) || $precio <  0 || empty($fecha) || strtotime($fecha) === false) {
        ...
        if (empty($id)) {
            $query = mysqli_query($conexion, "SELECT * FROM reconocimiento WHERE codigo = '$codigo'");
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO reconocimiento(codigo,numero,precio,fecha) values ('$codigo', '$reconum', '$precio', '$fecha')");
                if ($query_insert) {
                    $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        Acta de Reconocimiento Registrada
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>';
            ...
            $query_update = mysqli_query($conexion, "UPDATE reconocimiento SET codigo = '$codigo', numero = '$reconum', precio= $precio, fecha = '$fecha' WHERE codreco = $id");
            if ($query_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
...
<div class="card shadow-lg">
    <div class="card-body">
    <h2 class="titulo-formulario text-center mb-4">Actas de Reconocimiento</h2>
        <div class="row">
            <div class="col-md-12">
                <form action="" method="post" autocomplete="on" id="formulario">
                    ...
                    <div class="card-header-primary row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="reconum" class=" text-dark font-weight-bold"><i class="fas fa-hashtag"></i>Número de Acta</label>
                                <input type="number" placeholder="Ingrese numero de acta" name="reconum" id="reconum" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="fecha" class=" text-dark font-weight-bold"><i class="fa fa-calendar"></i> Fecha de Reconocimiento</label>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="tbl">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($conexion, "SELECT * FROM reconocimiento");
                        $result = mysqli_num_rows($query);
                        if ($result > 0) {
                            while ($data = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    <td><?php echo $data['codreco']; ?></td>
                                    <td><?php echo $data['codigo']; ?></td>
                                    <td><?php echo $data['numero']; ?></td>
                                    <td><?php echo $data['precio']; ?></td>
                                    <td><?php echo $data['fecha']; ?></td>
                                    <td>
                                        <a href="#" onclick="editarReconocimiento(<?php echo $data['codreco']; ?>)" class="btn btn-primary"><i class='fas fa-edit'></i></a>

                                        <form action="eliminar_reconocimiento.php?id=<?php echo $data['codreco']; ?>" method="post" class="confirmar d-inline">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Desea vaciar la tabla Actas de Reconocimiento?
            </div>
