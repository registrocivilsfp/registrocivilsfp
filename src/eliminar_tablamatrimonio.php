...
// Eliminar todos los registros de la tabla matrimonio
$sql_delete_all = "DELETE FROM matrimonio";
$query_delete_all = mysqli_query($conexion, $sql_delete_all);

if ($query_delete_all) {
    echo "Todos los registros de la tabla matrimonio han sido eliminados correctamente.<br>";
    ...
    echo "Error al intentar eliminar todos los registros de la tabla matrimonio.<br>";
}
